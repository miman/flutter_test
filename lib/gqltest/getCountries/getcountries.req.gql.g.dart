...
class _$GgetCountriesReq extends GgetCountriesReq {
  ...
  factory _$GgetCountriesReq(
      ...
      (new GgetCountriesReqBuilder()..update(updates)).build();
  ...
  _$GgetCountriesReq._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(vars, 'GgetCountriesReq', 'vars');
    BuiltValueNullFieldError.checkNotNull(
        operation, 'GgetCountriesReq', 'operation');
    BuiltValueNullFieldError.checkNotNull(
        executeOnListen, 'GgetCountriesReq', 'executeOnListen');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GgetCountriesReq')
          ..add('vars', vars)
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GgetCountriesReq', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
